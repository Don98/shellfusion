        ...
        <div class="input-group-append">
            ...
            <modal :show.sync="modals.modal1">
              <div v-highlight>
                ...
                MP Summary: <code v-highlight>{{ data1["MP Summary"] }}<br /></code>
                Most Similar TLDR Task: <code v-highlight>{{ data1["Most Similar TLDR Task"] }}<br /></code>
                Most Similar TLDR Script: <code v-highlight>{{ data1["Most Similar TLDR Script"] }}<br /></code>
                <br />
                ...
                <div v-for="(a, index) in data1['Top-3 Similar Questions']" :key="index">
                  <a @click="getUrl1(a.split(':')[0])" style="cursor: pointer;color: #1da1f2">Question: <code>{{a.split(':')[1]}}<br /></code></a>
                    Accepted Script: <pre><code v-highlight>{{data1['Top-3 Scripts'][index].split(':')[1].replace(' ', '')}}<br /></code></pre>
                </div>
                <br />
